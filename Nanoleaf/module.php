...
class Nanoleaf extends IPSModule
{
    ...
    public function GetAllInfo()
    {
        ...
        if($info)
        {
            ...
            $allinfo = ['name' => $name, 'serialnumber' => $serialNo, 'firmware' => $firmwareVersion, 'model' => $model, 'state' => $state, 'brightness' => $brightness, 'hue' => $hue, 'sat' => $sat, 'ct' => $ct, 'colormode' => $colormode];
            return $allinfo;
        }
        else
        {
